package com.termites.tools.swipemenulistview;
...
public class SwipeMenuListView extends EmptyViewListView {
    ...
    public void isOpenSlide(boolean isOpenSlide) {
        this.isOpenSlide = isOpenSlide;
    }
